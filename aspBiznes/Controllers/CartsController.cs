...
namespace aspBiznes.Controllers
{
    ...
    public class CartsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Carts.Include(c => c.Clients).Include(c => c.Items);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,ItemId,Quantity,DateRegister")] Cart cart)
        {
            cart.ClientId = _userManager.GetUserId(User);
            cart.DateRegister = DateTimeOffset.Now;
            if (id != cart.Id)
